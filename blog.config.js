...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NetConsole', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个底层程序猿🐒', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://geekpeng.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'geekpeng, 博客', // 网站关键词 英文逗号隔开
